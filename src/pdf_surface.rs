...
extern "C" {
    ...
    pub fn cairo_pdf_surface_create_for_stream (write_func: ffi::cairo_write_func_t,
                                                closure: *mut c_void,
                                                width_in_points: c_double,
                                                height_in_points: c_double) -> *mut ffi::cairo_surface_t;
}
...
impl PDFSurface {
    ...
    pub fn create_writer<W: Write + 'static>(writer: W, width: f64, height: f64) -> PDFSurface
    {
        ...
        unsafe {
            PDFSurface(
                Surface::from_raw_full(cairo_pdf_surface_create_for_stream(Some(write_to), writer as *mut _, width, height)),
